            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a href="{{ route('admin.school.create') }}" class="btn btn-primary">Add Class</a> </li>
                    </ul>
                            ...
                            @foreach($classes as $class)
                                ...
                                @else
                                    <tr class="odd pointer">
                                        ...
                                        <td class="property-column-data" style="text-align: right"><a href="{{ route('admin.school.classes', ['school' => $class->getId()]) }}">{{ $class->getName() }}</a></td>
                                        <td class="property-column-data", style="text-align: right">
                                            <a class="btn btn-default" href="{{ route('admin.school.edit', ['school' => $class->getId()]) }}">Edit</a>
